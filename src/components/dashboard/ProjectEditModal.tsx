...
export default function ProjectEditModal({ open, onClose, project, onSaved }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
      ...
      <div {...dialogProps} aria-label="Editar proyecto" className="relative bg-[#1C3448] border border-white/[0.12] rounded-2xl w-full max-w-md shadow-2xl max-h-[90vh] flex flex-col">
